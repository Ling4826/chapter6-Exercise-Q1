...
import static se233.chapter1.HelloApplication.refreshPane;
import static se233.chapter1.HelloApplication.setMainCharacter;
...
public class CharacterPane extends ScrollPane {
    ...
    private Pane getDetailsPane() {
        ...
        if (this.character != null) {
            ...
            mainImage.setImage(new Image(HelloApplication.class.getResource(character.getImagepath()).toString()));
            ...
            name = new Label("Name: ");
            mainImage.setImage(new Image(HelloApplication.class.getResource("assets/unknown.png").toString()));
            hp = new Label("HP: ");
            type = new Label("Type: ");
            atk = new Label("ATK: ");
            def = new Label("DEF: ");
        ...
        genCharacter.setOnAction(e -> {
            setMainCharacter(GenCharacter.setUpCharacter());
            refreshPane();
                    AllCustomHandler.backintime();
        });
