...
import static se233.chapter1.AllCustomHandler.onDragDetected;
import static se233.chapter1.AllCustomHandler.onEquipDone;
    ...
    private Pane getDetailsPane() {
        ...
        if (equipmentArray != null) {
            ...
            for (int i = 0; i < equipmentArray.size(); i++) {
                ...
                imageViewList[i].setImage(new Image(HelloApplication.class.getResource(
